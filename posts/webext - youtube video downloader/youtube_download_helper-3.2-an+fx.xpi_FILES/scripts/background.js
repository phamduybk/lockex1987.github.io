...
function handleMessage(message, sender) {
  ...
  url : message.url,
		...
		browser.tabs.sendMessage(sender.tab.id, {'action': 'applyEmbedOverlay', 'url': browser.extension.getURL("images/download-white.png")});
		...
		for (var i = 0; i < domChanges.length; i++) {
			...
			content = content.replace('##icon-url##', browser.extension.getURL("images/"));
			content = content.replace('##icon-url1##', browser.extension.getURL("images/"));
			content = content.replace('##icon-url2##', browser.extension.getURL("images/"));
			content = content.replace('##icon-url3##', browser.extension.getURL("images/"));			
			content = content.replace('##icon-url4##', browser.extension.getURL("images/"));
			content = content.replace('##icon-url5##', browser.extension.getURL("images/"));
