                ...
                if (keyValues.length == 2) {
                  ...
                  if (keyValues[0] == 'itag') {
                    if (keyValues[1].indexOf('137') != -1) {
                      ...
                      video['type'] = 'MP4';
                    } else if (keyValues[1].indexOf('136') != -1) {
                      video['itag'] = 'MP4 (720p) (No Audio)';
                      video['type'] = 'MP4';
...
function streammapHandleMessage(b) {
  if ("applyDOMChanges" == b.action)
    ...
    $ytmp4("#youtube-video-download-panel").show();
    ...
    /*
    if (b.target.getAttribute("id") == "youtube-video-download-button") {
      $ytmp4("#youtube-video-download-panel").show();
    }
    */
...
chrome.runtime.onMessage.addListener(streammapHandleMessage);
