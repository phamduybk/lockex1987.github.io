...
function Pagi(options) {
    ...
    this.showNumbers = options.showNumbers != null ? options.showNumbers : true;
                ...
                <div class="paginationWrapper">
                    ...
                    <ul ng-if="pag.totalPage > 1" class="pagination pull-right">
                        <li class="page-item {{pag.currentPage === 1 ? 'disabled' : ''}}" ng-if="pag.showFirst">
                            <a ng-click="pag.currentPage > 1 && gotoPage({ page: 1 })" href="#" class="page-link">
                                {{pag.firstText}}
                            </a>
                        </li>
                        <li class="page-item {{pag.currentPage === 1 ? 'disabled' : ''}}" ng-if="pag.showPrevious">
                            <a ng-click="pag.currentPage > 1 && gotoPage({ page: pag.currentPage - 1 })" href="#" class="page-link">
                                {{pag.previousText}}
                            </a>
                        </li>
                        <li ng-repeat="p in pag.pages" class="page-item {{pag.currentPage === p ? 'active' : ''}}">
                            <a ng-click="p != pag.currentPage && gotoPage({ page: p })" href="#" class="page-link">
                                {{p}}
                            </a>
                        </li>
                        <li class="page-item {{pag.currentPage === pag.totalPage ? 'disabled' : ''}}" ng-if="pag.showNext">
                            <a ng-click="pag.currentPage < pag.totalPage && gotoPage({ page: pag.currentPage + 1 })" href="#" class="page-link">
                                {{pag.nextText}}
                            </a>
                        </li>
                        <li class="page-item {{pag.currentPage === pag.totalPage ? 'disabled' : ''}}" ng-if="pag.showLast">
                            <a ng-click="pag.currentPage < pag.totalPage && gotoPage({ page: pag.totalPage })" href="#" class="page-link">
                                {{pag.lastText}}
                            </a>
                        </li>
                    </ul>
