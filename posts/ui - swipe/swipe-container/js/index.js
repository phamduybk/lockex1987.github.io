...
var outer = new HammerCarousel(
	document.querySelector(".panes.wrapper"), Hammer.DIRECTION_HORIZONTAL
);
...
$(document).ready(function() {
	...
	var myElement = document.querySelector('.table-view');
	var myOptions = {};

	//var swiper = new SwipeActions(document.querySelector(".table-view"), Hammer.DIRECTION_HORIZONTAL );
	Hammer.each(document.querySelectorAll(".table-row"), function(container) {
