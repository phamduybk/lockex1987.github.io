...
public class RandomDataGeneratorX {
    ...
    public static Customer randomCustomer(int id) {
        ...
        c.setSince(RandomDataGeneratorX.randomDate(LocalDate.of(1998, 01, 01), LocalDate.of(2016, 12, 31)));
    ...
    public static Purchase randomPurchase() {
        ...
        p.setDate(RandomDataGeneratorX.randomDateTime(
