...
public class FlyingSaucerTest {
    ...
    public void myTest() throws Exception {
    	String content = new String(Files.readAllBytes(Paths.get("book.html")));
    	String xHtml = convertToXhtml(content);
        ...
        OutputStream outputStream = new FileOutputStream("_output/book.pdf");
        renderer.createPDF(outputStream);
        outputStream.close();
        
        System.out.println("Flying saucer supports table of content (link and page number)");
    }
